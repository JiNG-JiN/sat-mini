 ...
 */
	...
	HeroSlideshow = View.extend({
		...
		initialize: function() {
			...
			this.$videoContainer = $('<div class="video-frame" id="video-frame"><a href="#" class="close-overlay">Close</a></div>').appendTo(this.$videoOverlay.find('.content'));
...
*/
			html = '<video src="/uploads/videos/' + videoId +'" width="100%" height="" controls preload autoplay="autoplay"></video>';
		...
		closeVideo: function() {
			...
			setTimeout(function() {
				_this.$videoContainer.find('video').remove();
			}, 300);
		}
	});
